...
import static com.testProject.random.Random.*;
    ...
    public static void main(String args[]){
        ...
        do{
            ...
            switch (FigureInit[count]){
                case 1: arrFigure[count] = new Circle(getRandom());break;
                case 2: arrFigure[count] = new Triangle(getRandom(),getRandom());break;
                case 3: arrFigure[count] = new Square(getRandom());break;
                case 4: arrFigure[count] = new Trapezium(getRandom(),getRandom(),getRandom());break;
            }
        ...
        for(int i = 0;i < arrFigure.length; i++){
            System.out.println(arrFigure[i].toString());
        }
    }
